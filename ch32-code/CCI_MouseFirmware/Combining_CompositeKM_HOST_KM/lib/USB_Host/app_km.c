...
extern uint8_t Com_Transfer[64];
extern uint8_t Com_Transferred;
...
extern void TIM3_IRQHandlerDevice( void );
                ...
                for( in_num = 0; in_num < HostCtl[ index ].Interface[ intf_num ].InEndpNum; in_num++ )
                {
                    ...
                    if( HostCtl[ index ].Interface[ intf_num ].InEndpTimeCount[ in_num ] >= HostCtl[ index ].Interface[ intf_num ].InEndpInterval[ in_num ] )
                    {
                        ...
                        if( s == ERR_SUCCESS )
                        {
                            ...
                            DUG_PRINTF( "\r\n" );
#endif
                            Com_Transfer[0] = Com_Buf[0];
                            Com_Transfer[1] = Com_Buf[1];
                            Com_Transfer[2] = Com_Buf[2];
                            Com_Transfer[3] = Com_Buf[3];
                            Com_Transferred = 1;
